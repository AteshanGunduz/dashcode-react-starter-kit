...
const Header = ({ className = "custom-class" , handleLanguage,  toggleLanguage}) => {
      ...
      >
        <div className="flex justify-between items-center h-full">
          ...
          <div className="nav-tools flex items-center lg:space-x-6 space-x-3 rtl:space-x-reverse">
            ...
            <SwitchDark />
            <MonoChrome />
            {width >= breakpoints.md && <Message toggleLanguage={toggleLanguage} />}
            {width >= breakpoints.md && <Notification toggleLanguage={toggleLanguage}/>}
            {width >= breakpoints.md && <Profile toggleLanguage={toggleLanguage} />}
