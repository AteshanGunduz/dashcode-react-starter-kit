          ...
          >
            ...
            {!item.child && !item.isHeadr && (
              <NavLink className="menu-link" to={item.link}>
                ...
                <div className="text-box flex-grow">{!toggleLanguage ? item.title : "Gösterge Paneli"}</div>
                {item.badge && <span className="menu-badge">{item.badge}</span>}
              </NavLink>
            )}
            {/* only for menulabel */}
            {item.isHeadr && !item.child && (
              <div className="menulabel">{!toggleLanguage ? item.title : "Menu"}</div>
            )}
            {/*    !!sub menu parent   */}
            {item.child && (
              ...
              >
                <div className="flex-1 flex items-start">
                  ...
                  <div className="text-box">{!toggleLanguage ? item.title : "Çoklu Seviye"}</div>
                </div>
